...
# Last modified on Fri Jul 16 2021
# Copyright (c) CaMOS Development Team. All Rights Reserved.
# Distributed under a MIT License. See LICENSE for more info.

# Code adapted from napari project
...
from camos.utils.apptools import sys_info


class QtAbout(QDialog):
    """Qt dialog window for displaying 'About CaMOS' information.
    Parameters
    ----------
    ...
    Attributes
    ----------
    citationCopyButton : CaMOS._qt.qt_about.QtCopyToClipboardButton
        Button to copy citation information to the clipboard.
    citationTextBox : qtpy.QtWidgets.QTextEdit
        Text box containing CaMOS citation information.
    citation_layout : qtpy.QtWidgets.QHBoxLayout
        Layout widget for CaMOS citation information.
    infoCopyButton : CaMOS._qt.qt_about.QtCopyToClipboardButton
        Button to copy CaMOS version information to the clipboard.
    info_layout : qtpy.QtWidgets.QHBoxLayout
        Layout widget for CaMOS version information.
    infoTextBox : qtpy.QtWidgets.QTextEdit
        Text box containing CaMOS version information.
    layout : qtpy.QtWidgets.QVBoxLayout
        Layout widget for the entire 'About CaMOS' dialog.
    """
    ...
    def __init__(self, parent=None):
        ...
        # Description
        title_label = QLabel(
            "<b>CaMOS</b><br>A toolbox for analysis of neural Ca2+ and CMOS recordings"
        )
